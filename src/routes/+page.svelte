<script>
    import SquareRoot from '$lib/icos/squareRoot.svelte';
...
<div class=" bg-white  rounded-3xl grid grid-cols-4 gap-1 p-6 font-semibold shadow-xl">
    ...
    <button class="bg-slate-100">%</button>
    <!--square root-->
    <button class="bg-slate-100">
        <SquareRoot/>
    </button>
    <button class="bg-slate-100"> CE</button>
    <button class="bg-blue-950 text-gray-50">C</button>
    ...
    <button>6</button>
    <!--divide-->
    <button class="text-white bg-sky-600 ">
    ...
    <button>3</button>
    <!--multiply-->
    <button class="bg-yellow-300 text-white ">
    ...
    <button>=</button>
    <!--add-->
    <button class="text-white bg-green-400">
